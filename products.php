...
<body>
    ...
    <div class="products mt-5">
        <div class="container" id="pro-cards">

            <p class="fw-light" id="text-title"><span class="p-title">OUR PRODUCTS</span><br>

            <div class="container">
                <div class="row g-2">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3">
                            <img src="./image/supplies/00496767_0.png" class="fixed-size">
                            <button type="button" class="btn btn-dark .btn-class">Inquire now</button>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3">
                            <img src="./image/supplies/ph-11134207-7rasg-m27z09ywhmde35.webp" class="fixed-size"
                                alt="...">
                            <button type="button" class="btn btn-dark .btn-class">Inquire now</button>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3">
                            <img src="./image/supplies/victorinox-victorinox-6-swiss-classic-curved-shapi.webp"
                                class="fixed-size" alt="...">
                            <button type="button" class="btn btn-dark .btn-class">Inquire now</button>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3"><img src="./image/supplies/F7492024-01.webp"
                                class="fixed-size" alt="...">
                            <button type="button" class="btn btn-dark .btn-class">Inquire now</button>
                        </div>
                    </div>
                ...
                <div class="row g-2 mt-3">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3">
                            <img src="./image/supplies/terminal lugs .png" class="fixed-size" alt="Product Image">
                            <button type="button" class="btn btn-dark btn-class">Inquire now</button>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3">
                            <img src="./image/supplies/step down transpormer.png" class="fixed-size" alt="...">
                            <button type="button" class="btn btn-dark btn-class">Inquire now</button>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3">
                            <img src="./image/supplies/highbay.png" class="fixed-size" alt="...">
                            <button type="button" class="btn btn-dark btn-class">Inquire now</button>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="p-3 border bg-light rounded-3">
                            <img src="./image/supplies/handy spring.png" class="fixed-size" alt="...">
                            <button type="button" class="btn btn-dark btn-class">Inquire now</button>
                        </div>
                    </div>
                </div>
